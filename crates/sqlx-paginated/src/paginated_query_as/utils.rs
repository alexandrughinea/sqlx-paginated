use crate::{DatabaseQueryDefaults, FieldSource, PaginatedQueryBuilder};
...
/// ```rust
/// use sqlx::Postgres;
/// use sqlx_paginated::{Fields, paginated_query_as};
///
/// # use sqlx::FromRow;
...
where
    ...
    T: for<'r> FromRow<'r, DB::Row> + Send + Unpin + FieldSource,
